---
title: "Regression Analysis of the Impact of the Tōhoku Tsunami Impact on Albatross Populations in the Hawaii"
author: "Julia Parish"
date: "2022-02-01"
output: 
  html_document:
...
bfal_qqplot <- ggplot(bfal_count) +
  ...
  labs(title = "Black-footed Albatross (BFAL) QQ Plot") +
  theme_minimal() +
...
laal_qqplot <- ggplot(laal_count) +
  ...
  xlab("Normal distribution quantiles") +
  ylab("Sample quantiles") +
  labs(title = "Laysan Albatross (LAAL) QQ Plot") +
  theme_minimal() +
  theme(line = element_blank(),
        panel.grid = element_blank(),
        strip.text = element_blank(),
...
tab_model(post_tsunami_simple_mod ,
          ...
          string.p = "P-value",
          title = "Tbl #. Simple Linear Regression Model for Banded Albatross in Hawaii",
          digits = 4)
```
...
tab_model(interaction_model,
          ...
          string.ci = "Conf. Int (95%)",
          string.p = "P-value",
          title = "Tbl #. Multiple Linear Regression Model Results for Banded Albatross in Hawaii",
          digits = 4)
```
