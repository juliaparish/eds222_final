...
This statistical analysis will be testing the hypothesis if the Tohoku tsunami impacted albatross populations in Hawaii. The table below outlines the phases of the analysis. 
...
pop_mean_table <- kable(pop_mean, 
                        ...
                        caption = "Hawaii Albatross Count Means") %>% 
